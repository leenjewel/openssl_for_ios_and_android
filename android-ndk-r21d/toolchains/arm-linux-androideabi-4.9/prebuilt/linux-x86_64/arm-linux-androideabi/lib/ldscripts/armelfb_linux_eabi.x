...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/buildbot/src/android/binutils/out/binutils/linux/arm/install/binutils-arm-linux/arm-linux-androideabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
